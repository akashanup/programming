class Solution:
    ...
    def longestPalindrome(self, s: str) -> str:
        ...
        for i in range(len(s)):
            # Make ith element as the middle element of odd length palindrome string. Keep moving backward and forward as long as the resulting string is palindrome.
            oddPalindromes = self.checkPalindrome(s, i, i)
            # Make ith and (i+1)th element as the middle elements of even length palindrome string. Keep moving backward and forward as long as the resulting string is palindrome.
